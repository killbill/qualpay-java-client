...
------------ | ------------- | ------------- | -------------
**shippingId** | **Long** | &lt;strong&gt;Format: &lt;/strong&gt;Variable length, up to 10 N&lt;br&gt;&lt;strong&gt;Description: &lt;/strong&gt;Shipping ID that should be set as the primary shipping address. The shipping id should belong to the customer.  | 

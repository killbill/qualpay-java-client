...
public class AddRecurringPlanRequest {
   ...
   * @return planCode
  **/
  @ApiModelProperty(example = "1234", required = true, value = "<strong>Format: </strong>Variable length, up to 16 AN<br><strong>Description: </strong>A unique alphanumeric code provided by the merchant to identify the plan.")
   ...
   * @return planName
  **/
  @ApiModelProperty(example = "Qualpay Plan", required = true, value = "<strong>Format: </strong>Variable length, up to 64 AN<br><strong>Description: </strong>A unique name assigned to the plan. ")
   ...
   * @return planDesc
  **/
  @ApiModelProperty(example = "ABC Monthly Billing Plan", required = true, value = "<strong>Format: </strong>Variable length AN<br><strong>Description: </strong>A short description of the plan.")
  ...
  **/
   ...
   * @return amtTran
  **/
  @ApiModelProperty(example = "19.99", required = true, value = "<strong>Format: </strong>Variable length, up to 12,2 N<br><strong>Description: </strong>Plan transaction amount. Amount that will be billed each cycle. ")
